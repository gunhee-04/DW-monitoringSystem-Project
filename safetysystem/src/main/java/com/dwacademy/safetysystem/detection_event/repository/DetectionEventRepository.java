...
public interface DetectionEventRepository extends JpaRepository<DetectionEntity, Long> {
    ...
    // 기존 메서드들
    List<DetectionEntity> findByCamera_IdOrderByIdDesc(Integer cameraId);
    ...
    List<DetectionEntity> findByCamera_IdAndEventTypeAndEventTimeBetweenOrderByIdDesc(
